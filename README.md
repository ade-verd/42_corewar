...
| **`st`**<br /><br />`REG`, `IND`&#124;`REG` | Stores the value of a register to an address or to an other register.<br /><br />*Example1: `st r4,34` stores the value of `r4` to the address `(PC + (34 % IDX_MOD))`*<br />*Example2: `st r3,r8` copies `r3` into `r8`* | 5 | Non | Oui | - |
