...
|:-: | ------- | :----------------: | :--------------------: | :----------: | :----------------: |
| `live`<br /><br />`DIR` |The instruction `live` is followed by 4 bytes which represents the player's player number as unsigned int. This instruction means the player is alive. | 10 | Non | Non | 4 |
